...
namespace cmdline {
    ...
    std::optional<lazybsd_value> parse(int argc, char* argv[])
    {
        ...
        try {
            ...
            description.add_options()("config,c", program_options::value<string>(), "Path of config file.")("script,s", program_options::value<string>(), "Path of script file.")(
                "proc_id,p", program_options::value<int32_t>(), "proc id")("proc_type,t", program_options::value<string>(), "proc type")("help,h", "Display this information.")(
                "version,v", "Display software version information.")("debug,d", "Run as debug mode.");
            ...
            if (variables_map.count("version") != 0) {
                fmt::print("{} \r\n"
                           "Copyright (C) 2025 MengDemao mengdemao19951021@gmail.com \n"
                           "This is free software; see the source for copying conditions.  There is NO\n"
                           "warranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.\n{}",
                           version::lazybsd_version_string(), version::lazybsd_component_version_string());
                return std::nullopt;
            }
